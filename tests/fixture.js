module.exports = {
  analizadores: {
    ...
    r4: { serie: 'SN-103', modelo: 'PQ-2', caso: 'C-004', lugar: 'Apopa', fechaInstalacion: '2026-07-01', fechaRetiro: '2026-07-20', areaInstalacion: 'CPT MT', equipoId: 'e4', retirado: true, fechaRetiroReal: '2026-07-21', retiroInfo: { sinProblema: false, fallas: ['LED intermitente'], descripcion: 'x', sede: 'Plantel Central' }, fechaRegistro: '2026-07-01T10:00' },
