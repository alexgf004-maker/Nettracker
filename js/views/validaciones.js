  ...
  if (state.valView === 'lista') {
    ...
    if (!camp2 || !u2) { state.valView = 'detalle'; }
      ...
      if (state.valTipoUsuario === 'monofasico') {
        ...
        html += '<div><div style="font-size:10px;color:var(--text3);margin-bottom:4px">Volt. Secundario (V)</div><select id="vf-ref-vs" onchange="valVSOtro(this)" style="width:100%;padding:9px;border:1.5px solid var(--border);border-radius:8px;font-family:var(--mono);font-size:13px;background:var(--white);color:var(--text);outline:none"><option value="">Seleccionar...</option><option value="208" '+(state.valForm.refVS==208?'selected':'')+'>208 V</option><option value="240" '+(state.valForm.refVS==240?'selected':'')+'>240 V</option><option value="480" '+(state.valForm.refVS==480?'selected':'')+'>480 V</option><option value="otro" '+(state.valForm.refVS==='otro'?'selected':'')+'>Otro...</option></select>'+(state.valForm.refVS==='otro'?'<input id="vf-ref-vs-otro" type="number" step="0.1" placeholder="Voltaje en V" oninput="valVSOtroVal(this)" value="'+(state.valForm.refVSOtro||'')+'" style="width:100%;padding:9px;border:1.5px solid #7c3aed;border-radius:8px;font-family:var(--mono);font-size:13px;outline:none;margin-top:4px">':'')+'</div>';
        // Lectura + TAP
        ...
        // CP Volt Secundario
        html += '<div><div style="font-size:10px;color:var(--text3);margin-bottom:4px">Volt. Secundario (V)</div><select id="vf-cp-vs" onchange="valVSOtro(this)" style="width:100%;padding:9px;border:1.5px solid var(--border);border-radius:8px;font-family:var(--mono);font-size:13px;background:var(--white);color:var(--text);outline:none"><option value="">Seleccionar...</option><option value="208" '+(state.valForm.cpVS==208?'selected':'')+'>208 V</option><option value="240" '+(state.valForm.cpVS==240?'selected':'')+'>240 V</option><option value="480" '+(state.valForm.cpVS==480?'selected':'')+'>480 V</option><option value="otro" '+(state.valForm.cpVS==='otro'?'selected':'')+'>Otro...</option></select>'+(state.valForm.cpVS==='otro'?'<input id="vf-cp-vs-otro" type="number" step="0.1" placeholder="Voltaje en V" oninput="valVSOtroVal(this)" value="'+(state.valForm.cpVSOtro||'')+'" style="width:100%;padding:9px;border:1.5px solid #7c3aed;border-radius:8px;font-family:var(--mono);font-size:13px;outline:none;margin-top:4px">':'')+'</div>';
        ...
        html += '<div style="grid-column:1/-1"><div style="font-size:10px;color:var(--text3);margin-bottom:4px">Volt. Secundario ref.</div><select id="vf-ref-vs" onchange="valVSOtro(this)" style="width:100%;padding:9px;border:1.5px solid var(--border);border-radius:8px;font-family:var(--mono);font-size:13px;background:var(--white);outline:none">'+bVS('refVS')+'</select>'+(state.valForm.refVS==='otro'?'<input id="vf-ref-vs-otro" type="number" step="0.1" placeholder="Voltaje en V" oninput="valVSOtroVal(this)" value="'+(state.valForm.refVSOtro||'')+'" style="width:100%;padding:9px;border:1.5px solid #7c3aed;border-radius:8px;font-family:var(--mono);font-size:13px;outline:none;margin-top:4px">':'')+'</div>';
        ...
        html += '<div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">';
        html += '<div style="grid-column:1/-1"><div style="font-size:10px;color:var(--text3);margin-bottom:4px">Volt. Secundario campaña</div><select id="vf-cp-vs" onchange="valVSOtro(this)" style="width:100%;padding:9px;border:1.5px solid var(--border);border-radius:8px;font-family:var(--mono);font-size:13px;background:var(--white);outline:none">'+bVS('cpVS')+'</select>'+(state.valForm.cpVS==='otro'?'<input id="vf-cp-vs-otro" type="number" step="0.1" placeholder="Voltaje en V" oninput="valVSOtroVal(this)" value="'+(state.valForm.cpVSOtro||'')+'" style="width:100%;padding:9px;border:1.5px solid #7c3aed;border-radius:8px;font-family:var(--mono);font-size:13px;outline:none;margin-top:4px">':'')+'</div>';
        ...
        html += '<div style="grid-column:1/-1"><div style="font-size:10px;color:var(--text3);margin-bottom:4px">Volt. Secundario ref.</div><select id="vf-ref-vs" onchange="valVSOtro(this)" style="width:100%;padding:9px;border:1.5px solid var(--border);border-radius:8px;font-family:var(--mono);font-size:13px;background:var(--white);outline:none">'+tVS('refVS')+'</select>'+(state.valForm.refVS==='otro'?'<input id="vf-ref-vs-otro" type="number" step="0.1" placeholder="Voltaje en V" oninput="valVSOtroVal(this)" value="'+(state.valForm.refVSOtro||'')+'" style="width:100%;padding:9px;border:1.5px solid #7c3aed;border-radius:8px;font-family:var(--mono);font-size:13px;outline:none;margin-top:4px">':'')+'</div>';
        ...
        html += '<div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">';
        html += '<div style="grid-column:1/-1"><div style="font-size:10px;color:var(--text3);margin-bottom:4px">Volt. Secundario campaña</div><select id="vf-cp-vs" onchange="valVSOtro(this)" style="width:100%;padding:9px;border:1.5px solid var(--border);border-radius:8px;font-family:var(--mono);font-size:13px;background:var(--white);outline:none">'+tVS('cpVS')+'</select>'+(state.valForm.cpVS==='otro'?'<input id="vf-cp-vs-otro" type="number" step="0.1" placeholder="Voltaje en V" oninput="valVSOtroVal(this)" value="'+(state.valForm.cpVSOtro||'')+'" style="width:100%;padding:9px;border:1.5px solid #7c3aed;border-radius:8px;font-family:var(--mono);font-size:13px;outline:none;margin-top:4px">':'')+'</div>';
