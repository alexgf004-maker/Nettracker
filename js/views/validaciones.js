  ...
  if (state.valView === 'lista') {
    ...
    if (!camp2 || !u2) { state.valView = 'detalle'; }
      ...
      if (state.valTipoUsuario === 'monofasico') {
        ...
        html += '<div><div style="font-size:10px;color:var(--text3);margin-bottom:4px">Volt. Secundario (V)</div><select id="vf-ref-vs" style="width:100%;padding:9px;border:1.5px solid var(--border);border-radius:8px;font-family:var(--mono);font-size:13px;background:var(--white);color:var(--text);outline:none"><option value="">Seleccionar...</option><option value="208" '+(state.valForm.refVS==208?'selected':'')+'>208 V</option><option value="240" '+(state.valForm.refVS==240?'selected':'')+'>240 V</option><option value="480" '+(state.valForm.refVS==480?'selected':'')+'>480 V</option><option value="otro">Otro...</option></select></div>';
        // Lectura + TAP
        ...
        // CP Volt Secundario
        html += '<div><div style="font-size:10px;color:var(--text3);margin-bottom:4px">Volt. Secundario (V)</div><select id="vf-cp-vs" style="width:100%;padding:9px;border:1.5px solid var(--border);border-radius:8px;font-family:var(--mono);font-size:13px;background:var(--white);color:var(--text);outline:none"><option value="">Seleccionar...</option><option value="208" '+(state.valForm.cpVS==208?'selected':'')+'>208 V</option><option value="240" '+(state.valForm.cpVS==240?'selected':'')+'>240 V</option><option value="480" '+(state.valForm.cpVS==480?'selected':'')+'>480 V</option><option value="otro">Otro...</option></select></div>';
